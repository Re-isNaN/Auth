...
async function AuthRoutes(app) {
  app.get("/teste", auth_controller_default.teste);
  app.post("/login", auth_controller_default.login);
  app.get("/refresh", auth_controller_default.refresh);
  app.put("/logout", auth_controller_default.logout);
}
