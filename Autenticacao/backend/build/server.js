...
if (_env.success === false) {
  console.error("\u274C Variaveis de ambiente inv\xE1lidas", _env.error.format());
  throw new Error("Variaveis de ambiente inv\xE1lidas");
}
var env = _env.data;
...
app.listen({ port: envConfig.PORT, host: "0.0.0.0" }, (err) => {
  ...
  console.log("Servidor em execu\xE7\xE3o na porta " + envConfig.PORT);
});
